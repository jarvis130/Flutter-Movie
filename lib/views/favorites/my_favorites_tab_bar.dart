...
class FavoritesTabBar extends StatefulWidget implements PreferredSizeWidget {
  final TabBar tabBar;
  final double translate;

  FavoritesTabBar({Key key, this.tabBar, this.translate}) : super(key: key);

  @override
  _FavoritesTabBarState createState() => _FavoritesTabBarState();
...
class _FavoritesTabBarState extends State<FavoritesTabBar> {
  double get allHeight => widget.preferredSize.height;

  @override
  Widget build(BuildContext context) {
    MediaQuery.of(context);
    var value = Screen.width * 0.75 - 10.0;
    return Stack(
      children: <Widget>[
        Positioned(
          ///搜索框
