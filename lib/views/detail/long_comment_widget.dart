...
class LongCommentWidget extends StatelessWidget {
  final CommentModel movieLongCommentsEntity;
        ...
        Expanded(
          ...
          children: <Widget>[
            ListView.builder(
              ...
              itemCount: widget.movieLongCommentsEntity.reviews == null ? 0 : widget.movieLongCommentsEntity.reviews.length,
            ),
            Text('话题，暂无数据~'),
            Text('讨论，暂无数据~')
          ],
