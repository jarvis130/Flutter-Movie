...
class SearchPage extends StatefulWidget {
  ...
  ///搜索框中的默认显示内容
  SearchPage({Key key, this.searchHintContent = '用一部电影来勾起你的回忆'})
      : super(key: key);
...
class _SearchPageState extends State<SearchPage> {
  ...
  SearchModel _searchResultEntity;
  var imgW;
  var imgH;
...
//        _searchResultEntity.products.isNotEmpty) {
...
//    }
  ...
  _getData(searchContent) async {

    SearchModel model = await SearchApi.getList(
