...
import 'package:movie/utils/event_bus.dart';
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset(widget.url)
      ...
      ..setLooping(true).then((_) {
        if (widget.positionTag == 0 &&  VideoDouyuDetailScene.firstInitTimes == 1) {
          VideoDouyuDetailScene.firstInitTimes = 2;
          _controller.play();
          videoPrepared = true;
        }
        setState(() {});
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  Image.asset('images/video_icon_praise.png',
                      width: 36, height: 36),
                  Text(
                    "1.6w",
                    style: TextStyle(
                ...
                GestureDetector(
                    child: Container(
                        child: Column(children: <Widget>[
                      Image.asset('images/video_msg_icon.png',
                          width: 36, height: 36),
                      Text(
                        "1.3w",
                        style: TextStyle(
                ...
                GestureDetector(
                    child: Container(
                        child: Column(children: <Widget>[
                      Image.asset('images/video_share_icon.png',
                          width: 36, height: 36),
                      Text(
                        "2.1w",
                        style: TextStyle(
