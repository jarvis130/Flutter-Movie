...
class Product {
  ...
  set pubId(int pubId) => _pubId = pubId;
  int get id => _id;
  ...
  List<LinkGoods> get linkGoods => _linkGoods;
  set linkGoods(List<LinkGoods> linkGoods) => _linkGoods = linkGoods;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    if (json['link_goods'] != null) {
      _linkGoods = new List<LinkGoods>();
      json['link_goods'].forEach((v) {
        _linkGoods.add(new LinkGoods.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._linkGoods != null) {
      data['link_goods'] = this._linkGoods.map((v) => v.toJson()).toList();
    }
...
class LinkGoods {
  ...
  LinkGoods({int goodsId, String goodsName, DefaultPhoto goodsThumb}) {
    this._goodsId = goodsId;
    this._goodsName = goodsName;
  ...
  LinkGoods.fromJson(Map<String, dynamic> json) {
    _goodsId = json['goods_id'];
    _goodsName = json['goods_name'];
